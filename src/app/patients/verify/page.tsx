  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white max-w-md w-full rounded-2xl shadow-xl p-8 text-center border border-slate-100">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-4">Patient Verification</h1>
        <p className="text-slate-600 mb-8">
          To receive prescription medication, our partner pharmacy requires a brief intake check. Click below to initiate the process.
        </p>
        <button 
